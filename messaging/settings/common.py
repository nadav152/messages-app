...
BASE_DIR_EXT = os.path.dirname(os.path.dirname(
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR_EXT, "staticfiles")
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'api.paging.AppResultsSetPagination',
